...
class InformasiPublikSeeder extends Seeder
{
    ...
    public function run()
    {
        $akademiks = [
            [
                'keyword'               => 'Pakta Integritas Fakultas Hukum UNIBA Madura',
                'image_header'          => 'default.JPG',
                'category_informasi_publik_id'   => '1',
            ],
            [
                'keyword'               => 'Aturan Gratifikasi Fakultas Hukum UNIBA Madura',
                'image_header'          => 'default.JPG',
            ...
            [
                'keyword'               => 'Uniba Madura Expo Fakultas Hukum UNIBA Madura',
                'image_header'          => 'default.JPG',
                'category_informasi_publik_id'   => '4',
            ],
            [
                'keyword'               => 'SOP Fakultas Hukum UNIBA Madura',
                'image_header'          => 'default.JPG',
