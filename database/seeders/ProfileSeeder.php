...
class ProfileSeeder extends Seeder
{
    ...
    public function run()
    {
        $profiles = [
            [
                'keyword'               => 'Sejarah Fakultas Hukum UNIBA Madura',
            ...
            [
                'keyword'               => 'Pimpinan Fakultas Hukum UNIBA Madura',
                'image_header'          => 'default.JPG',
                'category_profile_id'   => '3',
            ],
            [
                'keyword'               => 'Staff Dosen Fakultas Hukum UNIBA Madura',
                'image_header'          => 'default.JPG',
                'category_profile_id'   => '4',
            ],
            [
                'keyword'               => 'Fasilitas Fakultas Hukum UNIBA Madura',
                'image_header'          => 'default.JPG',
                'category_profile_id'   => '5',
            ],
            [
                'keyword'               => 'Akreditasi Fakultas Hukum UNIBA Madura',
                'image_header'          => 'default.JPG',
