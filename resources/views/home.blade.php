                                            ...
                                            <li class="col-xl-3 col-lg-3 col-md-6 single-essentials-colum text-center">
                                                <div class="single-essentials-item">
                                                    <div class="static-content">
                                                        ...
                                                        <h3><a href="{{ route('guest.fasilitas-fh') }}">Fasilitas FH</a></h3>
                                                        <div class="btn-box">
                                                            <a href="{{ route('guest.fasilitas-fh') }}">
                                                                <span class="icon-right-arrow-1"></span>
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="col-xl-3 col-lg-3 col-md-6 single-essentials-colum text-center">
                                                <div class="single-essentials-item">
                                                    <div class="static-content">
                                                        ...
                                                        <h3><a href="{{ route('guest.staff-dosen-fh') }}">Dosen FH</a></h3>
                                                        <div class="btn-box">
                                                            <a href="{{ route('guest.staff-dosen-fh') }}">
                                                                <span class="icon-right-arrow-1"></span>
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="col-xl-3 col-lg-3 col-md-6 single-essentials-colum text-center">
                                                <div class="single-essentials-item">
                                                    <div class="static-content">
                                                        ...
                                                        <h3><a href="{{ route('guest.akreditasi-fh') }}">Akreditasi</a></h3>
                                                        <div class="btn-box">
                                                            <a href="{{ route('guest.akreditasi-fh') }}">
                                                                <span class="icon-right-arrow-1"></span>
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="teaching-content teaching-content--style2">
                                                    <div class="sec-title">
                                                        ...
                                                        <div class="sub-title">
                                                            <p>Selamat datang di pusat informasi FH - UNIBA Madura.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <section class="testimonial-style9-area">
                                    <div class="container">
                                        <div class="sec-title">
                                            <h2>Program Studi</h2>
                                            <div class="sub-title">
                                                <p>Seluruh daftar program studi yang ada dalam Fakultas Hukum</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xl-12">
                                            ...
                                            <div class="col-xl-4 col-lg-4">
                                                <div class="single-blog-style1">
                                                    ...
                                                    <div class="text-holder">
                                                        <h3><a href=" @if($row->berita->category_berita_id == 1) {{route('berita-informasi-fh.show',$row->id)}} @elseif($row->berita->category_berita_id == 2) {{route('berita-pengumuman-fh.show',$row->id)}} @else # @endif">{{ $row->title }}</a></h3>
                                                        <div class="text">
                                                            {!! strip_tags(substr($row->content, 0, 100)) !!}&hellip;
                                                        </div>
                                                        <div class="bottom-box">
                                                            <div class="btn-box">
                                                                <a href="@if($row->berita->category_berita_id == 1) {{route('berita-informasi-fh.show',$row->id)}} @elseif($row->berita->category_berita_id == 2) {{route('berita-pengumuman-fh.show',$row->id)}} @else # @endif">
