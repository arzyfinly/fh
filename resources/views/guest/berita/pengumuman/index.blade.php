                                    ...
                                    <div class="single-blog-style2__text-holder">
                                        <div class="top">
                                            <div class="category-box">
                                                ...
                                                <p><a href="{{ route('guest.pengumuman-fh') }}" rel="category tag">Pengumuman</a></p>
                                            </div>
                                        </div>
                                        <h3 class="blog-title">
                                            <a href="{{ route('berita-pengumuman-fh.show',$row->id) }}">{{ $row->title }}</a>
                                        </h3>
                                        @if($countString == 100)
                                        ...
                                        <div class="bottom-box">
                                            <div class="btn-box">
                                                <a
                                                    href="{{ route('berita-pengumuman-fh.show',$row->id) }}">
                ...
                <div class="col-xl-3 col-lg-5">
                    <div class="thm-sidebar-box">
                        ...
                        <div id="categories-2" class="widget sidebar-search-box widget_categories">
                            ...
                            <ul>
                                <li class="cat-item cat-item-35"><a href="{{ route('guest.informasi-fh') }}">Informasi</a>
                                </li>
                                <li class="cat-item cat-item-86"><a href="{{ route('guest.pengumuman-fh') }}">Pengumuman</a>
                                </li>
                                <li class="cat-item cat-item-28"><a href="{{ route('guest.agenda-fh') }}">Agenda</a>
                                </li>
                            </ul>
                                            ...
                                            <div class="inner">
                                                <div class="img-box"
                                                    ...
                                                    <div class="overlay-content">
                                                        <a href=" @if($row->berita->category_berita_id == 1) {{route('berita-informasi-fh.show',$row->id)}} @elseif($row->berita->category_berita_id == 2) {{route('berita-pengumuman-fh.show',$row->id)}} @else # @endif"><i class="fa fa-link" aria-hidden="true"></i>
                                                    </a>
                                                    </div>
                                                </div>
                                                <div class="title-box">
                                                    ...
                                                    <h4>
                                                        <a href=" @if($row->berita->category_berita_id == 1) {{route('berita-informasi-fh.show',$row->id)}} @elseif($row->berita->category_berita_id == 2) {{route('berita-pengumuman-fh.show',$row->id)}} @else # @endif">{{ substr($row->title,0,30) }}&hellip;</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </li>
