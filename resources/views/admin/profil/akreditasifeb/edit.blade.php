@extends('layout.app')
@section('title', 'Akreditasi FH')
@section('akreditasi-fh-active', 'active')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Akreditasi FH') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Profil') }}</li>
            <li class="breadcrumb-item">{{ __('Akreditasi FH') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Akreditasi FH') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('akreditasi-fh.update', $akreditasi->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
