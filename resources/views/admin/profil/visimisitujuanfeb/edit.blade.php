...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">{{ __('VIsi Misi Tujuan FH') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit VIsi Misi Tujuan FH') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('visi-misi-tujuan-fh.update', $visimisi->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
