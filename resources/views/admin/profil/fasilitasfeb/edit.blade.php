@extends('layout.app')
@section('title', 'Fasilitas FH')
@section('fasilitas-fh-active', 'active')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Fasilitas FH') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Profil') }}</li>
            <li class="breadcrumb-item">{{ __('Fasilitas FH') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Fasilitas FH') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('fasilitas-fh.update', $fasilitas->id) }}" method="POST"
                                ...
                                <div class="col border-right">
                                    <div class="p-3 py-5">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="text-right">Fasilitas FH</h4>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-12">
