...
class BeasiswaController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($beasiswaKemahasiswaan)
                ...
                ->addColumn('image', function ($row) {
                    $content = '<img src="/images/beasiswa-fakultas/' . $row->image_content . '" alt="FH" title="FH" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('beasiswa-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/kemahasiswaan/info-kemahasiswaan/beasiswa-fh');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($kemahasiswaan){
            if ($request['publish']) {
                ...
                return redirect()->route('beasiswa-fh.index');
        } else {
    ...
    {
        return redirect('/kemahasiswaan/info-kemahasiswaan/beasiswa-fh');
    }
