...
class YudisiumWisudaController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($yudisiumwisudaall)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('yudisium-wisuda-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/akademik/yudisium-wisuda-fh');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($akademik){
            if ($request['publish']) {
                ...
                return redirect()->route('yudisium-wisuda-fh.index');
        } else {
    ...
    {
        return redirect('/akademik/visi-misi-tujuan-fh');
    }
