...
class SejarahController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($sejarahAll)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/sejarah-fakultas/' . $row->image_content . '" alt="FH" title="FH" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('sejarah-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/profil/sejarah-fh');
    }
    ...
    if($profil){
        if ($request['publish'] && $content < 1) {
            ...
            return redirect()->route('sejarah-fh.index');
    } else {
    ...
    {
        return redirect('/profil/sejarah-fh');
    }
