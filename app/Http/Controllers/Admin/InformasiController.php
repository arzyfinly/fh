...
class InformasiController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($informasiAll)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/berita-informasi/' . $row->image_content . '" alt="FH" title="FH" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('informasi-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/berita/informasi-fh');
    }
    ...
    if($informasi){
        if ($request['publish'] != null) {
            ...
            return redirect()->route('informasi-fh.index');
    } else {
    ...
    {
        return redirect('/berita/informasi-fh');
    }
