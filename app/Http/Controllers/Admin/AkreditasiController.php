...
class AkreditasiController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($akreditasiAll)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('akreditasi-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/profil/akreditasi-fh');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($profil){
            if ($request['publish']) {
                ...
                return redirect()->route('akreditasi-fh.index');
        } else {
    ...
    {
        return redirect('/profil/akreditasi-fh');
    }
