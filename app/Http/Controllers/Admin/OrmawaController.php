...
class OrmawaController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($ormawa)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/ormawa-fakultas/' . $row->image_content . '" alt="FH" title="FH" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn =        '<a href="' . route('ormawa-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/kemahasiswaan/ormawa-fh');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request['publish' == null]){
                ...
                return redirect()->route('ormawa-fh.index');
        } else {$content = [
            'kemahasiswaan_id'      => $kemahasiswaan->id,
            'title'                 => $data['title'],
            'description'           => $data['description'],
