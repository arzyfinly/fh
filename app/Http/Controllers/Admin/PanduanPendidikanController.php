...
class PanduanPendidikanController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($panduanPendidikan)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('panduan-pendidikan-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/akademik/panduan-pendidikan-fh');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($akademik){
                ...
                return redirect()->route('panduan-pendidikan-fh.index');
        } else {
