...
class ProfilPimpinanController extends Controller
{
   public function __construct()
        ...
        if ($request->ajax()) {
            return DataTables::of($pimpinanAll)
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/pimpinan-fakultas/' . $row->image_content . '" alt="FH" title="FH" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('pimpinan-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/profil/pimpinan-fh');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($profil){
            ...
            if (!$request['publish']) {
                ...
                return redirect()->route('pimpinan-fh.index');
        } else {
    ...
    {
        return redirect('/profil/pimpinan-fh');
    }
