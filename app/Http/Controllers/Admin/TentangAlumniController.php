...
class TentangAlumniController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($alumniAll)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/tentang-alumni/' . $row->image_content . '" alt="FH" title="FH" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('tentang-alumni-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/alumni/tentang-alumni-fh');
    }
    ...
    if($alumni){
        if ($request['publish'] != null) {
            ...
            return redirect()->route('tentang-alumni-fh.index');
    } else {
    ...
    {
        return redirect('/alumni/tentang-alumni-fh');
    }
