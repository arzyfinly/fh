...
class ProgramStudiController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($programStudi)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn =        '<a href="' . route('program-studi-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/akademik/program-studi-fh');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($akademik){
            if($publish){
                ...
                return redirect()->route('program-studi-fh.index');
            } else {
                $content = [
                'akademik_id'           => $akademik->id,
                'title'                 => $data['title'],
