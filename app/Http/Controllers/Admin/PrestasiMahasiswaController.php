...
class PrestasiMahasiswaController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($prestasimhsAll)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/prestasimhs-fakultas/' . $row->image_content . '" alt="FH" title="FH" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('prestasi-mahasiswa-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/kemahasiswaan/prestasi-mahasiswa-fh');
    }
    ...
    if($prestasimhs){
        if ($request['publish'] != null) {
            ...
            return redirect()->route('prestasi-mahasiswa-fh.index');
    } else {
    ...
    {
        return redirect('/kemahasiswaan/prestasi-mahasiswa-fh');
    }
