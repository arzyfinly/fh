...
class KalenderAkademikController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($kalenderAkademik)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('kalender-akademik-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/akademik/kalender-akademik-fh');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($akademik){
                ...
                return redirect()->route('kalender-akademik-fh.index');
        } else {
