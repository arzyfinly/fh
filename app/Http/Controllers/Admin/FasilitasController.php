...
class FasilitasController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($fasilitasAll)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/fasilitas-fakultas/' . $row->image_content . '" alt="FH" title="FH" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('fasilitas-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/profil/fasilitas-fh');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($profil){
            if ($request['publish']) {
                ...
                return redirect()->route('fasilitas-fh.index');
        } else {
    ...
    {
        return redirect('/profil/fasilitas-fh');
    }
