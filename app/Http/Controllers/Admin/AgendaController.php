...
class AgendaController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($agendaAll)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('agenda-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/berita/agenda-fh');
    }
    ...
    if($agenda){
        if ($request['publish'] != null) {
            ...
            return redirect()->route('agenda-fh.index');
    } else {
    ...
    {
        return redirect('/berita/agenda-fh');
    }
