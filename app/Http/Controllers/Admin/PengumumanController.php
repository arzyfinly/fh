...
class PengumumanController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($pengumumanAll)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/berita-pengumuman/' . $row->image_content . '" alt="FH" title="FH" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('pengumuman-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/berita/pengumuman-fh');
    }
    ...
    if($pengumuman){
        if ($request['publish'] != null) {
            ...
            return redirect()->route('pengumuman-fh.index');
    } else {
    ...
    {
        return redirect('/berita/pengumuman-fh');
    }
