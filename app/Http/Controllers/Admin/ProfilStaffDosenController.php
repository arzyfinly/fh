...
class ProfilStaffDosenController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($staffDosenAll)
                ...
                ->addColumn('image-content', function ($row) {
                    $content = '<img src="/images/staff-dosen-fakultas/' . $row->image_content . '" alt="FH" title="FH" width="100px"/>';
                    return $content;
                })
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('staff-dosen-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/profil/staff-dosen-fh');
    }
    ...
    if($profil){
            ...
            return redirect()->route('staff-dosen-fh.index');
    } else {
    ...
    {
        return redirect('/profil/staff-dosen-fh');
    }
