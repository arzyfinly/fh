...
class VisiMisiTujuanController extends Controller
{
        ...
        if ($request->ajax()) {
            return DataTables::of($visimisiAll)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="' . route('visi-misi-tujuan-fh.edit', $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-primary btn-sm"><span><i class="fas fa-pen-square"></i></span></a>';
                    $btn = $btn . '&nbsp;';
    ...
    public function header(Request $request)
    {
        ...
        return redirect('admin/profil/visi-misi-tujuan-fh');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($profil){
            if ($request['publish']) {
                ...
                return redirect()->route('visi-misi-tujuan-fh.index');
        } else {
    ...
    {
        return redirect('/profil/visi-misi-tujuan-fh');
    }
